...
public class Queen extends GCompound {
	Game shit = new Game();
	Figure queen;
	GImage sprite;
	int x;
	...
	public Queen(int in_x, int in_y, String col2) {
		x = in_x;
		y = in_y;
		col = col2;
		queen = new Figure(in_x, in_y, col);
		if (queen.isBlack()) {
	...
	public String toString() {
		String s = col + "queen, " + this.getX() + ", " + this.getY() + " " + legalIndicator();
		return s;
	}
